...
| 3.x | CSC-xx | Update Timestamp Certificate and Subordinate CA Requirements | xx xxxx 2023 |
...
The Timestamp Authority SHALL reject timestamp requests signed with SHA-1 digest algorithms.
